...
def filtering(input_file, output_dir):
    ...
    workbook = xlsxwriter.Workbook(output_full_path, {'constant_memory': True})
...
def main():
    input_file, output_dir = inputVar()

    filtering(input_file, output_dir)
